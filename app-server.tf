...
# Web-Server LaunchConfiguration
...
resource "aws_launch_configuration" "app" {
  ...
  user_data = filebase64("${path.module}/init-node-js-app.sh")
  lifecycle {
